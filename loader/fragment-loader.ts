...
export default class FragmentLoader {
  ...
  private updateStatsFromPart(frag: Fragment, part: Part) {
    ...
    fragStats.startTimeData.push(...partStats.startTimeData);
    fragStats.endTimeData.push(...partStats.endTimeData);
    if (fragStats.loaded != 0) fragStats.boxLoaded += partStats.boxLoaded;
    if (partTotal) {
